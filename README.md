...
- **The Landscape of Agentic Reinforcement Learning for LLMs: A Survey** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.02547-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.02547)
- **Symbolic learning enables self-evolving agents** `2025` [![arXiv](https://img.shields.io/badge/arXiv-2406.18532-b31b1b?style=flat-square)](https://arxiv.org/abs/2406.18532)
- **ReAct: Synergizing Reasoning and Acting in Language Models** `ICLR 2023` [![arXiv](https://img.shields.io/badge/arXiv-2210.03629-b31b1b?style=flat-square)](https://arxiv.org/abs/2210.03629)
...
- **Reflexion: language agents with verbal reinforcement learning** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/1b44b878bb782e6954cd888628510e90-Abstract-Conference.html)
...
- **From Human Memory to AI Memory: A Survey on Memory Mechanisms in the Era of LLMs** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.15965-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.15965)
- **Voyager: An Open-Ended Embodied Agent with Large Language Models** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=ehfRiF0R3a)
- **ReasoningBank: Scaling Agent Self-Evolving with Reasoning Memory** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.25140-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.25140)
...
- **Decomposed Prompting: A Modular Approach for Solving Complex Tasks** `ICLR 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=_nGgzQjzaRy)
- **Self-Consistency Improves Chain of Thought Reasoning in Language Models** `ICLR 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=1PL1NIMMrw)
- **Least-to-Most Prompting Enables Complex Reasoning in Large Language Models** `ICLR 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=WZH7099tgfM)
- **Plan-and-Solve Prompting: Improving Zero-Shot Chain-of-Thought Reasoning by Large Language Models** `2023`
- **PAL: Program-aided Language Models** `ICML 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v202/gao23f.html)
- **Program of Thoughts Prompting: Disentangling Computation from Reasoning for Numerical Reasoning Tasks** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=YfZ4ZPt8zd)
...
- **Calibrate Before Use: Improving Few-Shot Performance of Language Models** `ICML 2021` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v139/zhao21c.html)
- **Rethinking the Role of Demonstrations: What Makes In-Context Learning Work?** `2022` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2022.emnlp-main.759)
...
- **Prompt Programming for Large Language Models: Beyond the Few-Shot Paradigm** `2021` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1145/3411763.3451760)
...
- **Language Models as Knowledge Bases?** `2019` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/D19-1250)
- **How Much Knowledge Can You Pack Into the Parameters of a Language Model?** `2020` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2020.emnlp-main.437)
- **Large Language Models Struggle to Learn Long-Tail Knowledge** `ICML 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v202/kandpal23a.html)
...
- **Precise Zero-Shot Dense Retrieval without Relevance Labels** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2023.acl-long.99)
...
- **Active Retrieval Augmented Generation** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2023.emnlp-main.495)
- **Agentic Retrieval-Augmented Generation: A Survey on Agentic RAG** `2025` [![arXiv](https://img.shields.io/badge/arXiv-2501.09136-b31b1b?style=flat-square)](https://arxiv.org/abs/2501.09136)
- **Toolformer: Language Models Can Teach Themselves to Use Tools** `NeurIPS 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/d842425e4bf79ba039352da0f658a906-Abstract-Conference.html)
- **Toolalpaca: Generalized tool learning for language models with 3000 simulated cases** `arXiv 2023`
- **ToolLLM: Facilitating Large Language Models to Master 16000+ Real-world APIs** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=dHng2O0Jjr)
- **StableToolBench: Towards Stable Large-Scale Benchmarking on Tool Learning of Large Language Models** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.findings-acl.664)
- **Gorilla: Large Language Model Connected with Massive APIs** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2024/hash/e4c61f578ff07830f5c37378dd3ecb0d-Abstract-Conference.html)
- **WebGPT: Browser-assisted question-answering with human feedback** `arXiv 2021` [![arXiv](https://img.shields.io/badge/arXiv-2112.09332-b31b1b?style=flat-square)](https://arxiv.org/abs/2112.09332)
- **ToolACE: Winning the Points of LLM Function Calling** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=8EB8k6DdCU)
- **The Berkeley Function Calling Leaderboard (BFCL): From Tool Use to Agentic Evaluation of Large Language Models** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/patil25a.html)
- **Tool Learning with Foundation Models** `arXiv 2023` [![arXiv](https://img.shields.io/badge/arXiv-2304.08354-b31b1b?style=flat-square)](https://arxiv.org/abs/2304.08354)
- **Tool Learning with Large Language Models: A Survey** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2405.17935-b31b1b?style=flat-square)](https://arxiv.org/abs/2405.17935)
- **ReAct: Synergizing Reasoning and Acting in Language Models** `ICLR 2023` [![arXiv](https://img.shields.io/badge/arXiv-2210.03629-b31b1b?style=flat-square)](https://arxiv.org/abs/2210.03629)
- **FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness** `NeurIPS 2022`
- **Rethinking Attention with Performers** `ICLR 2021` [![arXiv](https://img.shields.io/badge/arXiv-2009.14794-b31b1b?style=flat-square)](https://arxiv.org/abs/2009.14794)
- **Big Bird: Transformers for Longer Sequences** `NeurIPS 2020` [![arXiv](https://img.shields.io/badge/arXiv-2007.14062-b31b1b?style=flat-square)](https://arxiv.org/abs/2007.14062)
- **Longformer: The Long-Document Transformer** `2020` [![arXiv](https://img.shields.io/badge/arXiv-2004.05150-b31b1b?style=flat-square)](https://arxiv.org/abs/2004.05150)
- **Gemini 1.5: Unlocking Multimodal Understanding Across Millions of Tokens of Context** `2024` [![arXiv](https://img.shields.io/badge/arXiv-2403.05530-b31b1b?style=flat-square)](https://arxiv.org/abs/2403.05530)
- **Mamba: Linear-Time Sequence Modeling with Selective State Spaces** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2312.00752-b31b1b?style=flat-square)](https://arxiv.org/abs/2312.00752)
- **LongBench: A Bilingual, Multitask Benchmark for Long Context Understanding** `ACL 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://aclanthology.org/2024.acl-long.172/)
...
- **Resum: Unlocking long-horizon search intelligence via context summarization** `arXiv 2025`
...
- **ToolACE: Winning the Points of LLM Function Calling** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=8EB8k6DdCU)
- **The Berkeley Function Calling Leaderboard (BFCL): From Tool Use to Agentic Evaluation of Large Language Models** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/patil25a.html)
- **Schema First Tool APIs for LLM Agents: A Controlled Study of Tool Misuse, Recovery, and Budgeted Performance** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.13404-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.13404)
- **Reflexion: language agents with verbal reinforcement learning** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/1b44b878bb782e6954cd888628510e90-Abstract-Conference.html)
...
- **Language Agent Tree Search Unifies Reasoning, Acting, and Planning in Language Models** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/zhou24r.html)
...
- **$\textSWE-bench$: Can Language Models Resolve Real-world Github Issues?** `ICLR 2024`
...
- **GAIA: a benchmark for General AI Assistants** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=fibxvahvs3)
- **$\textAgentBench$: Evaluating llms as agents** `arXiv 2023`
- **\(\tau\)-bench: A Benchmark for Tool-Agent-User Interaction in Real-World Domains** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2406.12045-b31b1b?style=flat-square)](https://arxiv.org/abs/2406.12045)
- **Search-o1: Agentic search-enhanced large reasoning models** `EMNLP 2025`
- **Search-R1: Training LLMs to Reason and Leverage Search Engines with Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.09516-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.09516)
- **$\textWebThinker$: Empowering large reasoning models with deep research capability** `arXiv 2025`
- **R1-Searcher: Incentivizing the Search Capability in LLMs via Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.05592-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.05592)
- **WebDancer: Towards Autonomous Information Seeking Agency** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.22648-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.22648)
...
- **OpenHands: An Open Platform for AI Software Developers as Generalist Agents** `ICLR 2025` [![arXiv](https://img.shields.io/badge/arXiv-2407.16741-b31b1b?style=flat-square)](https://arxiv.org/abs/2407.16741)
- **Effective Harnesses for Long-Running Agents** `2025`
...
- **MetaGPT: Meta Programming for A Multi-Agent Collaborative Framework** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=VtmBAGCN7o)
- **ChatDev: Communicative Agents for Software Development** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.acl-long.810)
- **Magentic-One: A Generalist Multi-Agent System for Solving Complex Tasks** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2411.04468-b31b1b?style=flat-square)](https://arxiv.org/abs/2411.04468)
- **AFlow: Automating Agentic Workflow Generation** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=z5uVAKwmjf)
...
- **Natural-Language Agent Harnesses** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.25723-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.25723)
...
- **HiAgent: Hierarchical Working Memory Management for Solving Long-Horizon Agent Tasks with Large Language Model** `ACL 2025`
- **Scaling Long-Horizon LLM Agent via Context-Folding** `2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.11967-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.11967)
- **AgentFold: Long-Horizon Web Agents with Proactive Context Management** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.24699-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.24699)
- **Agentic Context Engineering: Evolving Contexts for Self-Improving Language Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.04618-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.04618)
...
- **Memory as Action: Autonomous Context Curation for Long-Horizon Agentic Tasks** `2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.12635-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.12635)
- **From Human Memory to AI Memory: A Survey on Memory Mechanisms in the Era of LLMs** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.15965-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.15965)
...
- **Reflexion: language agents with verbal reinforcement learning** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/1b44b878bb782e6954cd888628510e90-Abstract-Conference.html)
- **ExpeL: LLM Agents Are Experiential Learners** `AAAI 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1609/aaai.v38i17.29936)
...
- **ReasoningBank: Scaling Agent Self-Evolving with Reasoning Memory** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.25140-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.25140)
- **Buffer of Thoughts: Thought-Augmented Reasoning with Large Language Models** `2024` [![arXiv](https://img.shields.io/badge/arXiv-2406.04271-b31b1b?style=flat-square)](https://arxiv.org/abs/2406.04271)
...
- **Voyager: An Open-Ended Embodied Agent with Large Language Models** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=ehfRiF0R3a)
- **LongMemEval: Benchmarking Chat Assistants on Long-Term Interactive Memory** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2410.10813-b31b1b?style=flat-square)](https://arxiv.org/abs/2410.10813)
...
- **Tool learning with large language models: a survey** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1007/s11704-024-40678-2)
- **The Evolution of Tool Use in LLM Agents: From Single-Tool Call to Multi-Tool Orchestration** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.22862-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.22862)
- **The Berkeley Function Calling Leaderboard (BFCL): From Tool Use to Agentic Evaluation of Large Language Models** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/patil25a.html)
- **StableToolBench: Towards Stable Large-Scale Benchmarking on Tool Learning of Large Language Models** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.findings-acl.664)
...
- **A Survey of AI Agent Protocols** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.16736-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.16736)
- **MCP-Atlas: A Large-Scale Benchmark for Tool-Use Competency with Real MCP Servers** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.00933-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.00933)
- **ComplexMCP: Evaluation of LLM Agents in Dynamic, Interdependent, and Large-Scale Tool Sandbox** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.10787-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.10787)
- **MCPMark: A Benchmark for Stress-Testing Realistic and Comprehensive MCP Use** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.24002-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.24002)
- **MCP-Universe: Benchmarking Large Language Models with Real-World Model Context Protocol Servers** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.14704-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.14704)
- **Schema First Tool APIs for LLM Agents: A Controlled Study of Tool Misuse, Recovery, and Budgeted Performance** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.13404-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.13404)
- **ToolSandbox: A Stateful, Conversational, Interactive Evaluation Benchmark for LLM Tool Use Capabilities** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.findings-naacl.65)
- **\(\tau\)-bench: A Benchmark for Tool-Agent-User Interaction in Real-World Domains** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2406.12045-b31b1b?style=flat-square)](https://arxiv.org/abs/2406.12045)
- **The Tool Decathlon: Benchmarking Language Agents for Diverse, Realistic, and Long-Horizon Task Execution** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.25726-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.25726)
- **AutomationBench** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.18934-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.18934)
- **VitaBench: Benchmarking LLM Agents with Versatile Interactive Tasks in Real-world Applications** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.26490-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.26490)
- **Benchmarking LLM Tool-Use in the Wild** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.06185-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.06185)
- **AgencyBench: Benchmarking the Frontiers of Autonomous Agents in 1M-Token Real-World Contexts** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://aclanthology.org/2026.acl-long.337/)
- **UltraHorizon: Benchmarking Agent Capabilities in Ultra Long-Horizon Scenarios** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.21766-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.21766)
- **RAG-MCP: Mitigating Prompt Bloat in LLM Tool Selection via Retrieval-Augmented Generation** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.03275-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.03275)
- **AnyTool: Self-Reflective, Hierarchical Agents for Large-Scale API Calls** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/du24h.html)
- **MCP-Zero: Active Tool Discovery for Autonomous LLM Agents** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2506.01056-b31b1b?style=flat-square)](https://arxiv.org/abs/2506.01056)
...
- **DeepAgent: A General Reasoning Agent with Scalable Toolsets** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1145/3774904.3792460)
- **ToolGen: Unified Tool Retrieval and Calling via Generation** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=XLMAMmowdY)
- **Executable Code Actions Elicit Better LLM Agents** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/wang24h.html)
...
- **From Tool Orchestration to Code Execution: A Study of MCP Design Choices** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.15945-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.15945)
- **A Comprehensive Survey on Agent Skills: Taxonomy, Techniques, and Applications** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.07358-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.07358)
- **Organizing, Orchestrating, and Benchmarking Agent Skills at Ecosystem Scale** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.02176-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.02176)
- **Equipping Agents for the Real World with Agent Skills** `2025`
- **Voyager: An Open-Ended Embodied Agent with Large Language Models** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=ehfRiF0R3a)
- **Beyond Static Tools: Test-Time Tool Evolution for Scientific Reasoning** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.07641-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.07641)
- **CASCADE: Cumulative Agentic Skill Creation through Autonomous Development and Evolution** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2512.23880-b31b1b?style=flat-square)](https://arxiv.org/abs/2512.23880)
- **SEAgent: Self-Evolving Computer Use Agent with Autonomous Learning from Experience** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.04700-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.04700)
- **SkillCraft: Can LLM Agents Learn to Use Tools Skillfully?** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.00718-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.00718)
...
- **When Single-Agent with Skills Replace Multi-Agent Systems and When They Fail** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.04748-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.04748)
- **Memento: Fine-tuning LLM Agents without Fine-tuning LLMs** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.16153-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.16153)
- **Alita: Generalist Agent Enabling Scalable Agentic Reasoning with Minimal Predefinition and Maximal Self-Evolution** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.20286-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.20286)
...
- **SKILL0: In-Context Agentic Reinforcement Learning for Skill Internalization** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.02268-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.02268)
- **Agent Skills for Large Language Models: Architecture, Acquisition, Security, and the Path Forward** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.12430-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.12430)
- **Beyond Semantic Similarity: Rethinking Retrieval for Agentic Search via Direct Corpus Interaction** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.05242-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.05242)
...
- **CodeScout: An Effective Recipe for Reinforcement Learning of Code Search Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.17829-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.17829)
...
- **SkillOpt: Executive Strategy for Self-Evolving Agent Skills** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.23904-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.23904)
- **SkillNet: Create, Evaluate, and Connect AI Skills** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.04448-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.04448)
- **Skill-it! A data-driven skills framework for understanding and training language models** `NeurIPS 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/70b8505ac79e3e131756f793cd80eb8d-Abstract-Conference.html)
- **SkillGraph: Skill-Augmented Reinforcement Learning for Agents via Evolving Skill Graphs** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.12039-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.12039)
- **GraSP: Graph-Structured Skill Compositions for LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.17870-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.17870)
...
- **Multi-Agent Collaboration Mechanisms: A Survey of LLMs** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2501.06322-b31b1b?style=flat-square)](https://arxiv.org/abs/2501.06322)
- **Large Language Model Based Multi-agents: A Survey of Progress and Challenges** `IJCAI 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://www.ijcai.org/proceedings/2024/890)
- **Natural-Language Agent Harnesses** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.25723-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.25723)
- **Why Do Multi-Agent LLM Systems Fail?** `NeurIPS 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2025/hash/b1041e52d3be19f0a9bc491657488e4a-Abstract-Datasets_and_Benchmarks_Track.html)
- **TDAG: A multi-agent framework based on dynamic Task Decomposition and Agent Generation** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1016/j.neunet.2025.107200)
- **Agent-Oriented Planning in Multi-Agent Systems** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=EqcLAU6gyU)
- **Magentic-One: A Generalist Multi-Agent System for Solving Complex Tasks** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2411.04468-b31b1b?style=flat-square)](https://arxiv.org/abs/2411.04468)
- **Mixture-of-Agents Enhances Large Language Model Capabilities** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=h0ZfDIrj7T)
- **AgentVerse: Facilitating Multi-Agent Collaboration and Exploring Emergent Behaviors** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=EHg5GDnyq1)
- **Dynamic LLM-Agent Network: An LLM-agent Collaboration Framework with Agent Team Optimization** `arXiv 2023` [![arXiv](https://img.shields.io/badge/arXiv-2310.02170-b31b1b?style=flat-square)](https://arxiv.org/abs/2310.02170)
- **Scaling Large Language Model-based Multi-Agent Collaboration** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=K3n5jPkrU6)
- **Agint: Agentic Graph Compilation for Software Engineering Agents** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2511.19635-b31b1b?style=flat-square)](https://arxiv.org/abs/2511.19635)
- **Flash-Searcher: Fast and Effective Web Agents via DAG-Based Parallel Execution** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.25301-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.25301)
- **AFlow: Automating Agentic Workflow Generation** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=z5uVAKwmjf)
- **GPTSwarm: Language Agents as Optimizable Graphs** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/zhuge24a.html)
- **EvoRoute: Experience-Driven Self-Routing LLM Agent Systems** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://aclanthology.org/2026.acl-long.1771/)
- **Chimera: Latency- and Performance-Aware Multi-agent Serving for Heterogeneous LLMs** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.22206-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.22206)
- **ORCH: many analyses, one merge - a deterministic multi-agent orchestrator for discrete-choice reasoning with EMA-guided routing** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.3389/frai.2026.1748735)
- **MasRouter: Learning to Route LLMs for Multi-Agent Systems** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.acl-long.757)
- **AOrchestra: Automating Sub-Agent Creation for Agentic Orchestration** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.03786-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.03786)
...
- **Multi-Agent Collaboration via Evolving Orchestration** `NeurIPS 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2025/hash/f1320d2e2842169c6fc89dcbd80e94d0-Abstract-Conference.html)
- **SwarmAgentic: Towards Fully Automated Agentic System Generation via Swarm Intelligence** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.emnlp-main.93)
- **CORAL: Towards Autonomous Multi-Agent Evolution for Open-Ended Discovery** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.01658-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.01658)
- **Drop the Hierarchy and Roles: How Self-Organizing LLM Agents Outperform Designed Structures** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.28990-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.28990)
...
- **A Survey of AI Agent Protocols** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.16736-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.16736)
- **A survey of agent interoperability protocols: Model Context Protocol (MCP), Agent Communication Protocol (ACP), Agent-to-Agent Protocol (A2A), and Agent Network Protocol (ANP)** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.02279-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.02279)
- **LOKA Protocol: A Decentralized Framework for Trustworthy and Ethical AI Agent Ecosystems** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.10915-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.10915)
- **A Scalable Communication Protocol for Networks of Large Language Models** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2410.11905-b31b1b?style=flat-square)](https://arxiv.org/abs/2410.11905)
- **Peer-to-peer Autonomous Agent Communication Network** `2021` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://www.ifaamas.org/Proceedings/aamas2021/pdfs/p1037.pdf)
- **Self-Consistency Improves Chain of Thought Reasoning in Language Models** `ICLR 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=1PL1NIMMrw)
- **More Agents Is All You Need** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=bgzUSZ8aeg)
- **s1: Simple test-time scaling** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.emnlp-main.1025)
- **Agentic Aggregation for Parallel Scaling of Long-Horizon Agentic Tasks** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.11753-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.11753)
- **Agentic Test-Time Scaling for WebAgents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.12276-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.12276)
...
- **SelfCheckGPT: Zero-Resource Black-Box Hallucination Detection for Generative Large Language Models** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2023.emnlp-main.557)
- **VeriGuard: Enhancing LLM Agent Safety via Verified Code Generation** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.05156-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.05156)
- **AgentHarm: A Benchmark for Measuring Harmfulness of LLM Agents** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=AC5n7xHuR1)
...
- **Improving Factuality and Reasoning in Language Models through Multiagent Debate** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/du24e.html)
- **Multi-Agent Verification: Scaling Test-Time Compute with Multiple Verifiers** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2502.20379-b31b1b?style=flat-square)](https://arxiv.org/abs/2502.20379)
- **Let's Verify Step by Step** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=v8L0pN6EOi)
- **AgentPRM: Process Reward Models for LLM Agents via Step-Wise Promise and Progress** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1145/3774904.3792551)
...
- **Process Reward Models That Think** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.16828-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.16828)
...
- **SWE-TRACE: Optimizing Long-Horizon SWE Agents Through Rubric Process Reward Models and Heuristic Test-Time Scaling** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.14820-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.14820)
- **Verified Critical Step Optimization for LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.03412-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.03412)
...
- **Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena** `NeurIPS 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/91f18a1287b398d378ef22505bf41832-Abstract-Datasets_and_Benchmarks.html)
- **Agent-as-a-Judge: Evaluate Agents with Agents** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/zhuge25a.html)
...
- **WebArena: A Realistic Web Environment for Building Autonomous Agents** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=oKn9c6ytLx)
- **SWE-bench: Can Language Models Resolve Real-world Github Issues?** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=VTF8yNQM66)
...
- **Chain-of-Verification Reduces Hallucination in Large Language Models** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.findings-acl.212)
- **Math-Shepherd: Verify and Reinforce LLMs Step-by-step without Human Annotations** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.acl-long.510)
- **Free Process Rewards without Process Labels** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/yuan25c.html)
- **Self-Consistency Improves Chain of Thought Reasoning in Language Models** `ICLR 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=1PL1NIMMrw)
- **Language Agent Tree Search Unifies Reasoning, Acting, and Planning in Language Models** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/zhou24r.html)
- **rStar-Math: Small LLMs Can Master Math Reasoning with Self-Evolved Deep Thinking** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/guan25f.html)
...
- **Scaling LLM Test-Time Compute Optimally Can be More Effective than Scaling Parameters for Reasoning** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=4FWAwZtd2n)
- **DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2501.12948-b31b1b?style=flat-square)](https://arxiv.org/abs/2501.12948)
...
- **Titans: Learning to Memorize at Test Time** — neural long-term memory module.<br/>![venue](https://img.shields.io/badge/2025-555?style=flat-square) [![arXiv](https://img.shields.io/badge/arXiv-2501.00663-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2501.00663)
...
- **Efficient Transformers: A Survey** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1145/3530811)
- **State-Space Modeling in Long Sequence Processing: A Survey on Recurrence in the Transformer Era** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2406.09062-b31b1b?style=flat-square)](https://arxiv.org/abs/2406.09062)
- **GShard: Scaling Giant Models with Conditional Computation and Automatic Sharding** `arXiv 2020` [![arXiv](https://img.shields.io/badge/arXiv-2006.16668-b31b1b?style=flat-square)](https://arxiv.org/abs/2006.16668)
- **Switch Transformers: Scaling to Trillion Parameter Models with Simple and Efficient Sparsity** `2022`
- **Qwen3 Technical Report** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.09388-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.09388)
- **DeepSeek-V2: A Strong, Economical, and Efficient Mixture-of-Experts Language Model** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2405.04434-b31b1b?style=flat-square)](https://arxiv.org/abs/2405.04434)
- **Jamba: Hybrid Transformer-Mamba Language Models** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=9y8k2Y17o6)
- **Attention is All you Need** `NeurIPS 2017` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.neurips.cc/paper/2017/hash/3f5ee243547dee91fbd053c1c4a845aa-Abstract.html)
- **Longformer: The Long-Document Transformer** `arXiv 2020` [![arXiv](https://img.shields.io/badge/arXiv-2004.05150-b31b1b?style=flat-square)](https://arxiv.org/abs/2004.05150)
- **Big Bird: Transformers for Longer Sequences** `NeurIPS 2020` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.neurips.cc/paper/2020/hash/c8512d142a2d849725f31a9a7a361ab9-Abstract.html)
- **Mistral 7B** `arXiv 2023` [![arXiv](https://img.shields.io/badge/arXiv-2310.06825-b31b1b?style=flat-square)](https://arxiv.org/abs/2310.06825)
- **Gemma 2: Improving Open Language Models at a Practical Size** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2408.00118-b31b1b?style=flat-square)](https://arxiv.org/abs/2408.00118)
- **Gemma 3 Technical Report** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.19786-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.19786)
- **ReAct: Synergizing Reasoning and Acting in Language Models** `ICLR 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=WE_vluYUL-X)
- **WebArena: A Realistic Web Environment for Building Autonomous Agents** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=oKn9c6ytLx)
- **GQA: Training Generalized Multi-Query Transformer Models from Multi-Head Checkpoints** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2023.emnlp-main.298)
- **LongBench: A Bilingual, Multitask Benchmark for Long Context Understanding** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.acl-long.172)
- **Lost in the Middle: How Language Models Use Long Contexts** `2024`
- **Qwen2.5 Technical Report** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2412.15115-b31b1b?style=flat-square)](https://arxiv.org/abs/2412.15115)
- **ChatGLM: A Family of Large Language Models from GLM-130B to GLM-4 All Tools** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2406.12793-b31b1b?style=flat-square)](https://arxiv.org/abs/2406.12793)
...
- **Linformer: Self-Attention with Linear Complexity** `arXiv 2020` [![arXiv](https://img.shields.io/badge/arXiv-2006.04768-b31b1b?style=flat-square)](https://arxiv.org/abs/2006.04768)
- **Rethinking Attention with Performers** `ICLR 2021` [![arXiv](https://img.shields.io/badge/arXiv-2009.14794-b31b1b?style=flat-square)](https://arxiv.org/abs/2009.14794)
- **Retentive Network: A Successor to Transformer for Large Language Models** `arXiv 2023` [![arXiv](https://img.shields.io/badge/arXiv-2307.08621-b31b1b?style=flat-square)](https://arxiv.org/abs/2307.08621)
- **Efficiently Modeling Long Sequences with Structured State Spaces** `ICLR 2022` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=uYLFoz1vlAC)
- **Mamba-360: Survey of State Space Models as Transformer Alternative for Long Sequence Modelling: Methods, Applications, and Challenges** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2404.16112-b31b1b?style=flat-square)](https://arxiv.org/abs/2404.16112)
- **DeepSeek-V3 Technical Report** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2412.19437-b31b1b?style=flat-square)](https://arxiv.org/abs/2412.19437)
- **Kimi K2: Open Agentic Intelligence** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2507.20534-b31b1b?style=flat-square)](https://arxiv.org/abs/2507.20534)
- **Kimi Linear: An Expressive, Efficient Attention Architecture** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.26692-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.26692)
- **Fast Inference from Transformers via Speculative Decoding** `ICML 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v202/leviathan23a.html)
- **Better \& Faster Large Language Models via Multi-token Prediction** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/gloeckle24a.html)
- **Fast Transformer Decoding: One Write-Head is All You Need** `arXiv 2019` [![arXiv](https://img.shields.io/badge/arXiv-1911.02150-b31b1b?style=flat-square)](https://arxiv.org/abs/1911.02150)
- **Medusa: Simple LLM Inference Acceleration Framework with Multiple Decoding Heads** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/cai24b.html)
- **EAGLE: Speculative Sampling Requires Rethinking Feature Uncertainty** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/li24bt.html)
...
- **The Landscape of Agentic Reinforcement Learning for LLMs: A Survey** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=RY19y2RI1O)
- **The Long-Horizon Task Mirage? Diagnosing Where and Why Agentic Systems Break** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.11978-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.11978)
- **On Training Large Language Models for Long-Horizon Tasks: An Empirical Study of Horizon Length** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.02572-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.02572)
- **AgentSynth: Scalable Task Generation for Generalist Computer-Use Agents** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2506.14205-b31b1b?style=flat-square)](https://arxiv.org/abs/2506.14205)
- **TaskCraft: Automated Generation of Agentic Tasks** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2506.10055-b31b1b?style=flat-square)](https://arxiv.org/abs/2506.10055)
- **WebWalker: Benchmarking LLMs in Web Traversal** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.acl-long.508)
- **WebDancer: Towards Autonomous Information Seeking Agency** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.22648-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.22648)
- **WebSailor: Navigating Super-human Reasoning for Web Agent** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2507.02592-b31b1b?style=flat-square)](https://arxiv.org/abs/2507.02592)
- **WebShaper: Agentically Data Synthesizing via Information-Seeking Formalization** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2507.15061-b31b1b?style=flat-square)](https://arxiv.org/abs/2507.15061)
- **WebSailor-V2: Bridging the Chasm to Proprietary Agents via Synthetic Data and Scalable Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.13305-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13305)
- **WebWeaver: Structuring Web-Scale Evidence with Dynamic Outlines for Open-Ended Deep Research** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.13312-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13312)
- **Training Software Engineering Agents and Verifiers with SWE-Gym** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/pan25g.html)
- **R2E: Turning any Github Repository into a Programming Agent Environment** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/jain24c.html)
- **SWE-smith: Scaling Data for Software Engineering Agents** `NeurIPS 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2025/hash/8b86cf5ace600c48fd188efbb8dedec8-Abstract-Datasets_and_Benchmarks_Track.html)
- **DIVE: Scaling Diversity in Agentic Task Synthesis for Generalizable Tool Use** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.11076-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.11076)
- **A Matter of TASTE: Improving Coverage and Difficulty of Agent Benchmarks** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.28556-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.28556)
- **CLI-Gym: Scalable CLI Task Generation via Agentic Environment Inversion** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.10999-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.10999)
- **WebRL: Training LLM Web Agents via Self-Evolving Online Curriculum Reinforcement Learning** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=oVKEAFjEqv)
- **Learn-by-interact: A Data-Centric Framework For Self-Adaptive Agents in Realistic Environments** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=3UKOzGWCVY)
- **AgentFrontier: Expanding the Capability Frontier of LLM Agents with ZPD-Guided Data Synthesis** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.24695-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.24695)
- **CuES: A Curiosity-driven and Environment-grounded Synthesis Framework for Agentic RL** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2512.01311-b31b1b?style=flat-square)](https://arxiv.org/abs/2512.01311)
- **Immersion in the GitHub Universe: Scaling Coding Agents to Mastery** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.09892-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.09892)
- **SWE-Hub: A Unified Production System for Scalable, Executable Software Engineering Tasks** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.00575-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.00575)
- **Terminal-Bench: Benchmarking Agents on Hard, Realistic Tasks in Command Line Interfaces** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.11868-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.11868)
- **Computer Environments Elicit General Agentic Intelligence in LLMs** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.16206-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.16206)
- **Towards General Agentic Intelligence via Environment Scaling** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.13311-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13311)
- **EnvScaler: Scaling Tool-Interactive Environments for LLM Agent via Programmatic Synthesis** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.05808-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.05808)
- **WebArena: A Realistic Web Environment for Building Autonomous Agents** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=oKn9c6ytLx)
...
- **OSWorld-MCP: Benchmarking MCP Tool Invocation In Computer-Use Agents** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.24563-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.24563)
- **AutoWebWorld: Synthesizing Infinite Verifiable Web Environments via Finite State Machines** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.14296-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.14296)
- **InfiniteWeb: Scalable Web Environment Synthesis for GUI Agent Training** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.04126-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.04126)
- **MedAgentGym: A Scalable Agentic Training Environment for Code-Centric Reasoning in Biomedical Data Science** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2506.04405-b31b1b?style=flat-square)](https://arxiv.org/abs/2506.04405)
- **SciAgentGym: Benchmarking Multi-Step Scientific Tool-use in LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.12984-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.12984)
- **PaperArena: An Evaluation Benchmark for Tool-Augmented Agentic Reasoning on Scientific Literature** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.10909-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.10909)
- **Diffusion for World Modeling: Visual Details Matter in Atari** `NeurIPS 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2024/hash/6bdde0373d53d4a501249547084bed43-Abstract-Conference.html)
- **Diffusion Models Are Real-Time Game Engines** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2408.14837-b31b1b?style=flat-square)](https://arxiv.org/abs/2408.14837)
- **MineWorld: a Real-Time and Open-Source Interactive World Model on Minecraft** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.08388-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.08388)
- **Matrix-Game: Interactive World Foundation Model** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2506.18701-b31b1b?style=flat-square)](https://arxiv.org/abs/2506.18701)
- **Empowering World Models with Reflection for Embodied Video Prediction** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/chi25b.html)
- **DreamGen: Unlocking Generalization in Robot Learning through Video World Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.12705-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.12705)
- **World Action Models are Zero-shot Policies** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.15922-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.15922)
- **Cosmos World Foundation Model Platform for Physical AI** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2501.03575-b31b1b?style=flat-square)](https://arxiv.org/abs/2501.03575)
- **AdaWorld: Learning Adaptable World Models with Latent Actions** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/gao25u.html)
- **Is Your LLM Secretly a World Model of the Internet? Model-Based Planning for Web Agents** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=c6l7yA0HSq)
- **LLMs as Scalable, General-Purpose Simulators For Evolving Digital Agent Training** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.14969-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.14969)
- **WebEvolver: Enhancing Web Agent Self-Improvement with Co-evolving World Model** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.emnlp-main.454)
- **WebWorld: A Large-Scale World Model for Web Agent Training** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.14721-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.14721)
- **Code2World: A GUI World Model via Renderable Code Generation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.09856-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.09856)
- **MobileDreamer: Generative Sketch World Model for GUI Agent** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.04035-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.04035)
- **SWE-World: Building Software Engineering Agents in Docker-Free Environments** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.03419-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.03419)
- **Self-Supervised Learning from Images with a Joint-Embedding Predictive Architecture** `CVPR 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1109/CVPR52729.2023.01499)
- **seq-JEPA: Autoregressive Predictive Learning of Invariant-Equivariant World Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.03176-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.03176)
- **Back to the Features: DINO as a Foundation for Video World Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2507.19468-b31b1b?style=flat-square)](https://arxiv.org/abs/2507.19468)
- **V-JEPA 2: Self-Supervised Video Models Enable Understanding, Prediction and Planning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2506.09985-b31b1b?style=flat-square)](https://arxiv.org/abs/2506.09985)
- **AppWorld: A Controllable World of Apps and People for Benchmarking Interactive Coding Agents** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.acl-long.850)
- **ToolSandbox: A Stateful, Conversational, Interactive Evaluation Benchmark for LLM Tool Use Capabilities** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.findings-naacl.65)
- **\(\tau\)-bench: A Benchmark for Tool-Agent-User Interaction in Real-World Domains** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2406.12045-b31b1b?style=flat-square)](https://arxiv.org/abs/2406.12045)
- **MCPVerse: An Expansive, Real-World Benchmark for Agentic Tool Use** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.16260-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.16260)
- **MCP-Universe: Benchmarking Large Language Models with Real-World Model Context Protocol Servers** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.14704-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.14704)
- **MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.20453-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.20453)
- **MCPMark: A Benchmark for Stress-Testing Realistic and Comprehensive MCP Use** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.24002-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.24002)
- **Safe and Scalable Web Agent Learning via Recreated Websites** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.10505-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.10505)
- **MedMCP-Calc: Benchmarking LLMs for Realistic Medical Calculator Scenarios via MCP Integration** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.23049-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.23049)
- **FinMTM: A Multi-Turn Multimodal Benchmark for Financial Reasoning and Agent Evaluation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.03130-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.03130)
- **AgentRewardBench: Evaluating Automatic Evaluations of Web Agent Trajectories** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.08942-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.08942)
- **TOUCAN: Synthesizing 1.5M Tool-Agentic Data from Real-World MCP Environments** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.01179-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.01179)
- **OpenResearcher: A Fully Open Pipeline for Long-Horizon Deep Research Trajectory Synthesis** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.20278-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.20278)
- **ASTRA: Automated Synthesis of agentic Trajectories and Reinforcement Arenas** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.21558-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.21558)
- **Scalable Data Synthesis for Computer Use Agents with Step-Level Filtering** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2512.10962-b31b1b?style=flat-square)](https://arxiv.org/abs/2512.10962)
- **ANCHOR: Branch-Point Data Generation for GUI Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.07153-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.07153)
- **HATS: Hardness-Aware Trajectory Synthesis for GUI Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.12138-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.12138)
...
- **AgentRL: Scaling Agentic Reinforcement Learning with a Multi-Turn, Multi-Task Framework** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.04206-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.04206)
- **Beyond Ten Turns: Unlocking Long-Horizon Agentic Search with Large-Scale Asynchronous RL** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.07976-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.07976)
- **DPEPO: Diverse Parallel Exploration Policy Optimization for LLM-based Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.24320-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.24320)
- **Agent Lightning: Train ANY AI Agents with Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.03680-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.03680)
- **Verified Critical Step Optimization for LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.03412-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.03412)
- **Verifiable Process Rewards for Agentic Reasoning** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.10325-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.10325)
- **GEAR: Granularity-Adaptive Advantage Reweighting for LLM Agents via Self-Distillation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.11853-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.11853)
- **AgentHER: Hindsight Experience Replay for LLM Agent Trajectory Relabeling** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.21357-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.21357)
- **AOI: Turning Failed Trajectories into Training Signals for Autonomous Cloud Diagnosis** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.03378-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.03378)
- **PIVOT: Bridging Planning and Execution in LLM Agents via Trajectory Refinement** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.11225-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.11225)
...
- **ReSum: Unlocking Long-Horizon Search Intelligence via Context Summarization** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.13313-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13313)
- **Scaling Long-Horizon LLM Agent via Context-Folding** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.11967-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.11967)
- **AgentFold: Long-Horizon Web Agents with Proactive Context Management** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.24699-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.24699)
- **Memory as Action: Autonomous Context Curation for Long-Horizon Agentic Tasks** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.12635-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.12635)
- **Memory-R2: Fair Credit Assignment for Long-Horizon Memory-Augmented LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.21768-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.21768)
...
- **Qwen2.5 Technical Report** — data-mixture & long-context training at scale.<br/>![venue](https://img.shields.io/badge/2024-555?style=flat-square) [![arXiv](https://img.shields.io/badge/arXiv-2412.15115-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2412.15115)
...
- **s1: Simple Test-Time Scaling** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2501.19393-b31b1b?style=flat-square)](https://arxiv.org/abs/2501.19393)
...
- **ToolACE: Winning the Points of LLM Function Calling** `ICLR 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=8EB8k6DdCU)
- **TOUCAN: Synthesizing 1.5M Tool-Agentic Data from Real-World MCP Environments** `arXiv 2025`
...
- **Tool-Star: Empowering LLM-Brained Multi-Tool Reasoner via Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.16410-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.16410)
- **KLong: Training LLM Agent for Extremely Long-Horizon Tasks** `arXiv 2026`
...
- **WebAgent-R1: Training Web Agents via End-to-End Multi-Turn Reinforcement Learning** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.emnlp-main.401)
- **DeepRetrieval: Hacking Real Search Engines and Retrievers with Large Language Models via Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.00223-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.00223)
- **DeepResearcher: Scaling Deep Research via Reinforcement Learning in Real-world Environments** `2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.03160-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.03160)
...
- **$\textToolRL$: Reward is all tool learning needs** `arXiv 2025`
- **Tool-R1: Sample-Efficient Reinforcement Learning for Agentic Tool Use** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.12867-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.12867)
- **$\textTool-Star$: Empowering LLM-Brained Multi-Tool Reasoner via Reinforcement Learning** `arXiv 2025`
- **AdaTIR: Adaptive Tool-Integrated Reasoning via Difficulty-Aware Policy Optimization** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.14696-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.14696)
- **EAPO: Enhancing Policy Optimization with On-Demand Expert Assistance** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.23730-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.23730)
- **ET-Agent: Incentivizing Effective Tool-Integrated Reasoning Agent via Behavior Calibration** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.06860-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.06860)
- **SmartSearch: Process Reward-Guided Query Refinement for Search Agents** `arXiv 2026`
- **AgentPRM: Process Reward Models for LLM Agents via Step-Wise Promise and Progress** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1145/3774904.3792551)
- **CriticSearch: Fine-Grained Credit Assignment for Search Agents via a Retrospective Critic** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2511.12159-b31b1b?style=flat-square)](https://arxiv.org/abs/2511.12159)
- **SALT: Step-level Advantage Assignment for Long-horizon Agents via Trajectory Graph** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2026.findings-eacl.247)
...
- **Rubrics as Rewards: Reinforcement Learning Beyond Verifiable Domains** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2507.17746-b31b1b?style=flat-square)](https://arxiv.org/abs/2507.17746)
- **Reinforcement Learning with Rubric Anchors** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.12790-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.12790)
- **OpenRubrics: Towards Scalable Synthetic Rubric Generation for Reward Modeling and LLM Alignment** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.07743-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.07743)
- **Chasing the Tail: Effective Rubric-based Reward Modeling for Large Language Model Post-Training** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.21500-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.21500)
- **Agentic Rubrics as Contextual Verifiers for SWE Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.04171-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.04171)
- **DR Tulu: Reinforcement Learning with Evolving Rubrics for Deep Research** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2511.19399-b31b1b?style=flat-square)](https://arxiv.org/abs/2511.19399)
...
- **Prometheus: Inducing Fine-Grained Evaluation Capability in Language Models** `ICLR 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=8euJaTveKw)
- **R3: Robust Rubric-Agnostic Reward Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.13388-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.13388)
- **Breaking the Exploration Bottleneck: Rubric-Scaffolded Reinforcement Learning for General LLM Reasoning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.16949-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.16949)
- **StepPO: Step-Aligned Policy Optimization for Agentic Reinforcement Learning** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.18401-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.18401)
- **Turn-PPO: Turn-Level Advantage Estimation with PPO for Improved Multi-Turn RL in Agentic LLMs** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2026.findings-eacl.328)
- **Proximal policy optimization algorithms** `arXiv 2017`
- **High-Dimensional Continuous Control Using Generalized Advantage Estimation** `ICLR 2016` [![arXiv](https://img.shields.io/badge/arXiv-1506.02438-b31b1b?style=flat-square)](https://arxiv.org/abs/1506.02438)
- **Training Language Models to Follow Instructions with Human Feedback** `NeurIPS 2022`
...
- **Understanding R1-Zero-Like Training: A Critical Perspective** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.20783-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.20783)
...
- **CE-GPPO: Coordinating Entropy via Gradient-Preserving Clipping Policy Optimization in Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.20712-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.20712)
- **Group Sequence Policy Optimization** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2507.18071-b31b1b?style=flat-square)](https://arxiv.org/abs/2507.18071)
- **BNPO: Beta Normalization Policy Optimization** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2506.02864-b31b1b?style=flat-square)](https://arxiv.org/abs/2506.02864)
- **GPG: A Simple and Strong Reinforcement Learning Baseline for Model Reasoning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.02546-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.02546)
- **On-Policy RL with Optimal Reward Baseline** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.23585-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.23585)
- **CPGD: Toward Stable Rule-based Reinforcement Learning for Language Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.12504-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.12504)
...
- **Hierarchy-of-Groups Policy Optimization for Long-Horizon Agentic Tasks** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.22817-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.22817)
...
- **Tree Search for LLM Agent Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.21240-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.21240)
...
- **HiPER: Hierarchical Reinforcement Learning with Explicit Credit Assignment for Large Language Model Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.16165-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.16165)
- **Hindsight Credit Assignment for Long-Horizon LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.08754-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.08754)
- **The Entropy Mechanism of Reinforcement Learning for Reasoning Language Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.22617-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.22617)
- **Understanding and Preventing Entropy Collapse in RLVR with On-Policy Entropy Flow Optimization** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.11491-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.11491)
- **CURE: Critical-Token-Guided Re-Concatenation for Entropy-Collapse Prevention** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.11016-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.11016)
...
- **EPO: Entropy-regularized Policy Optimization for LLM Agents Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.22576-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.22576)
- **Agentic reinforced policy optimization** `arXiv 2025`
...
- **The Landscape of Agentic Reinforcement Learning for LLMs: A Survey** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=RY19y2RI1O)
- **A Survey of Reinforcement Learning for Large Reasoning Models** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.08827-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.08827)
- **ReAct: Synergizing Reasoning and Acting in Language Models** `ICLR 2023` [![arXiv](https://img.shields.io/badge/arXiv-2210.03629-b31b1b?style=flat-square)](https://arxiv.org/abs/2210.03629)
- **Toolformer: Language Models Can Teach Themselves to Use Tools** `NeurIPS 2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/d842425e4bf79ba039352da0f658a906-Abstract-Conference.html)
- **Reflexion: language agents with verbal reinforcement learning** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2023/hash/1b44b878bb782e6954cd888628510e90-Abstract-Conference.html)
- **Voyager: An Open-Ended Embodied Agent with Large Language Models** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=ehfRiF0R3a)
- **R1-Searcher: Incentivizing the Search Capability in LLMs via Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.05592-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.05592)
- **WebRL: Training LLM Web Agents via Self-Evolving Online Curriculum Reinforcement Learning** `2024` [![arXiv](https://img.shields.io/badge/arXiv-2411.02337-b31b1b?style=flat-square)](https://arxiv.org/abs/2411.02337)
- **WebDancer: Towards Autonomous Information Seeking Agency** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2505.22648-b31b1b?style=flat-square)](https://arxiv.org/abs/2505.22648)
- **WebSailor-V2: Bridging the Chasm to Proprietary Agents via Synthetic Data and Scalable Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.13305-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13305)
- **WebSailor: Navigating Super-human Reasoning for Web Agent** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2507.02592-b31b1b?style=flat-square)](https://arxiv.org/abs/2507.02592)
- **WebResearcher: Unleashing unbounded reasoning capability in Long-Horizon Agents** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.13309-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13309)
- **Resum: Unlocking long-horizon search intelligence via context summarization** `arXiv 2025`
- **WebWeaver: Structuring Web-Scale Evidence with Dynamic Outlines for Open-Ended Deep Research** [![arXiv](https://img.shields.io/badge/arXiv-2509.13312-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13312)
- **Tree of thoughts: Deliberate problem solving with large language models** `NeurIPS 2023`
- **Reasoning with Language Model is Planning with World Model** `2023` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2023.emnlp-main.507)
- **Language Agent Tree Search Unifies Reasoning, Acting, and Planning in Language Models** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/zhou24r.html)
- **AT\(^\mbox2\)PO: Agentic Turn-based Policy Optimization via Tree Search** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.04767-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.04767)
- **TreePO: Bridging the Gap of Policy Optimization and Efficacy and Inference Efficiency with Heuristic Tree-based Modeling** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2508.17445-b31b1b?style=flat-square)](https://arxiv.org/abs/2508.17445)
...
- **Toward Effective Tool-Integrated Reasoning via Self-Evolved Preference Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.23285-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.23285)
- **LiteResearcher: A Scalable Agentic RL Training Framework for Deep Research Agent** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.17931-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.17931)
- **TCOD: Exploring Temporal Curriculum in On-Policy Distillation for Multi-turn Autonomous Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.24005-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.24005)
- **Divide and Conquer: Grounding LLMs as Efficient Decision-Making Agents via Offline Hierarchical Reinforcement Learning** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/hu25q.html)
- **Hierarchical Reinforcement Learning with Augmented Step-Level Transitions for LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.05808-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.05808)
...
- **SKILL0: In-Context Agentic Reinforcement Learning for Skill Internalization** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.02268-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.02268)
- **THOR: Tool-Integrated Hierarchical Optimization via RL for Mathematical Reasoning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.13761-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.13761)
- **LLM Collaboration with Multi-Agent Reinforcement Learning** `AAAI 2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1609/aaai.v40i38.40487)
...
- **QMIX: Monotonic Value Function Factorisation for Deep Multi-Agent Reinforcement Learning** `ICML 2018` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://proceedings.mlr.press/v80/rashid18a.html)
...
- **Improving Factuality and Reasoning in Language Models through Multiagent Debate** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://openreview.net/forum?id=QAwaaLJNCk)
...
- **WebExplorer: Explore and Evolve for Training Long-Horizon Web Agents** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.06501-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.06501)
- **Behavioral Cloning from Observation** `IJCAI 2018` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.24963/ijcai.2018/687)
- **Deep Reinforcement Learning from Human Preferences** `NeurIPS 2017` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.neurips.cc/paper/2017/hash/d5e2c0adad503c91f91df240d0cd4e49-Abstract.html)
- **Revisiting DAgger in the Era of LLM-Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.12913-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.12913)
- **MAD-OPD: Breaking the Ceiling in On-Policy Distillation via Multi-Agent Debate** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.01347-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.01347)
- **Healthcare AI GYM for Medical Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.02943-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.02943)
- **LiteGUI: Distilling Compact GUI Agents with Reinforcement Learning** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.07505-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.07505)
- **\(\pi\)-Play: Multi-Agent Self-Play via Privileged Self-Distillation without External Data** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.14054-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.14054)
- **KAT-Coder-V2 Technical Report** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.27703-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.27703)
- **SOD: Step-wise On-policy Distillation for Small Language Model Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.07725-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.07725)
- **TCOD: Exploring Temporal Curriculum in On-Policy Distillation for Multi-turn Autonomous Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.24005-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.24005)
- **StepOPSD: Step-Aware Online Preference Distillation for Agent Reinforcement Learning** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.27140-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.27140)
- **Self-Distillation Zero: Self-Revision Turns Binary Rewards into Dense Supervision** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.12002-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.12002)
- **Reinforcement Learning via Self-Distillation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.20802-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.20802)
- **Learning with Rare Success but Rich Feedback via Reflection-Enhanced Self-Distillation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.12741-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.12741)
- **Vision-OPD: Learning to See Fine Details for Multimodal LLMs via On-Policy Self-Distillation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.18740-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.18740)
- **Skill-SD: Skill-Conditioned Self-Distillation for Multi-turn LLM Agents** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.10674-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.10674)
- **SkillOpt: Executive Strategy for Self-Evolving Agent Skills** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.23904-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.23904)
- **f-OPD: Stabilizing Long-Horizon On-Policy Distillation with Freshness-Aware Control** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2605.17862-b31b1b?style=flat-square)](https://arxiv.org/abs/2605.17862)
- **TIP: Token Importance in On-Policy Distillation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.14084-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.14084)
- **Revisiting On-Policy Distillation: Empirical Failure Modes and Simple Fixes** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2603.25562-b31b1b?style=flat-square)](https://arxiv.org/abs/2603.25562)
...
- **Self-Rewarding Language Models** — the model judges and improves itself.<br/>![venue](https://img.shields.io/badge/2024-555?style=flat-square) [![arXiv](https://img.shields.io/badge/arXiv-2401.10020-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2401.10020)
...
- **Self-Improving Language Models for Evolutionary Program Synthesis: A Case Study on ARC-AGI** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/pourcel25a.html)
- **SAMULE: Self-Learning Agents Enhanced by Multi-level Reflection** `2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2025.emnlp-main.839)
- **WebRL: Training LLM Web Agents via Self-Evolving Online Curriculum Reinforcement Learning** `2024` [![arXiv](https://img.shields.io/badge/arXiv-2411.02337-b31b1b?style=flat-square)](https://arxiv.org/abs/2411.02337)
- **RAGEN: Understanding Self-Evolution in LLM Agents via Multi-Turn Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.20073-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.20073)
- **AgentGym-RL: Training LLM Agents for Long-Horizon Decision Making through Multi-Turn Reinforcement Learning** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.08755-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.08755)
- **DeepResearcher: Scaling Deep Research via Reinforcement Learning in Real-world Environments** `2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.03160-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.03160)
...
- **$\textSPIRAL$: Self-Play on Zero-Sum Games Incentivizes Reasoning via Multi-Agent Multi-Turn Reinforcement Learning** `arXiv 2025`
- **Don't Just Fine-tune the Agent, Tune the Environment** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.10197-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.10197)
- **RLVE: Scaling Up Reinforcement Learning for Language Models with Adaptive Verifiable Environments** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2511.07317-b31b1b?style=flat-square)](https://arxiv.org/abs/2511.07317)
- **GenEnv: Difficulty-Aligned Co-Evolution Between LLM Agents and Environment Simulators** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2512.19682-b31b1b?style=flat-square)](https://arxiv.org/abs/2512.19682)
- **Agent-World: Scaling Real-World Environment Synthesis for Evolving General Agent Intelligence** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2604.18292-b31b1b?style=flat-square)](https://arxiv.org/abs/2604.18292)
- **CoMAS: Co-Evolving Multi-Agent Systems via Interaction Rewards** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2510.08529-b31b1b?style=flat-square)](https://arxiv.org/abs/2510.08529)
- **SkillRL: Evolving Agents via Recursive Skill-Augmented Reinforcement Learning** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.08234-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.08234)
...
- **AutoCodeRover: Autonomous Program Improvement** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.1145/3650212.3680384)
- **R2E: Turning any Github Repository into a Programming Agent Environment** `ICML 2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v235/jain24c.html)
- **Qwen3-Coder-Next Technical Report** `arXiv 2026`
- **SWE-Bench Pro: Can AI Agents Solve Long-Horizon Software Engineering Tasks?** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.16941-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.16941)
- **DevEval: A Manually-Annotated Code Generation Benchmark Aligned with Real-World Code Repositories** `2024` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://doi.org/10.18653/v1/2024.findings-acl.214)
- **OpenClaw: An Open-Source Agent Runtime** `2025`
- **Improving Deep Agents with Harness Engineering** `2026` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://www.langchain.com/blog/improving-deep-agents-with-harness-engineering)
- **Magentic-One: A Generalist Multi-Agent System for Solving Complex Tasks** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2411.04468-b31b1b?style=flat-square)](https://arxiv.org/abs/2411.04468)
- **Scaling Managed Agents: Decoupling the Brain from the Hands** `2025`
...
- **Training Software Engineering Agents and Verifiers with SWE-Gym** `ICML 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](https://proceedings.mlr.press/v267/pan25g.html)
- **SWE-smith: Scaling Data for Software Engineering Agents** `NeurIPS 2025` [![paper](https://img.shields.io/badge/%F0%9F%93%84_paper-4b5563?style=flat-square)](http://papers.nips.cc/paper_files/paper/2025/hash/8b86cf5ace600c48fd188efbb8dedec8-Abstract-Datasets_and_Benchmarks_Track.html)
- **Agentless: Demystifying LLM-based Software Engineering Agents** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2407.01489-b31b1b?style=flat-square)](https://arxiv.org/abs/2407.01489)
...
<details>
<summary>📚 <b>More from the survey</b> — 41 papers</summary>
...
- **Search-o1: Agentic search-enhanced large reasoning models** `EMNLP 2025`
- **EviNote-RAG: Enhancing RAG Models via Answer-Supportive Evidence Notes** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.00877-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.00877)
...
- **GraphSearch: An Agentic Deep Searching Workflow for Graph Retrieval-Augmented Generation** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2509.22009-b31b1b?style=flat-square)](https://arxiv.org/abs/2509.22009)
...
- **Laser: Governing Long-Horizon Agentic Search via Structured Protocol and Context Register** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2512.20458-b31b1b?style=flat-square)](https://arxiv.org/abs/2512.20458)
...
- **Webweaver: Structuring web-scale evidence with dynamic outlines for open-ended deep research** `arXiv 2025`
- **Deep research: A survey of autonomous research agents** `arXiv 2025`
- **Webthinker: Empowering large reasoning models with deep research capability** `NeurIPS 2025` [![arXiv](https://img.shields.io/badge/arXiv-2504.21776-b31b1b?style=flat-square)](https://arxiv.org/abs/2504.21776)
...
- **Learnact: Few-shot mobile gui agent with a unified demonstration benchmark** `2026`
...
- **Mind-Brush: Integrating Agentic Cognitive Search and Reasoning into Image Generation** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.01756-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.01756)
- **GenAgent: Scaling Text-to-Image Generation via Agentic Multimodal Reasoning** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2601.18543-b31b1b?style=flat-square)](https://arxiv.org/abs/2601.18543)
...
- **MUSE: A Multi-agent Framework for Unconstrained Story Envisioning via Closed-Loop Cognitive Orchestration** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.03028-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.03028)
...
- **Agent-Omni: Test-Time Multimodal Reasoning via Model Coordination for Understanding Anything** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2511.02834-b31b1b?style=flat-square)](https://arxiv.org/abs/2511.02834)
...
- **OSWorld: Benchmarking Multimodal Agents for Open-Ended Tasks in Real Computer Environments** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2404.07972-b31b1b?style=flat-square)](https://arxiv.org/abs/2404.07972)
- **WebArena: A Realistic Web Environment for Building Autonomous Agents** `arXiv 2023` [![arXiv](https://img.shields.io/badge/arXiv-2307.13854-b31b1b?style=flat-square)](https://arxiv.org/abs/2307.13854)
...
- **GR00T N1: An Open Foundation Model for Generalist Humanoid Robots** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.14734-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.14734)
...
- **LawThinker: A Deep Research Legal Agent in Dynamic Environments** `arXiv 2026` [![arXiv](https://img.shields.io/badge/arXiv-2602.12056-b31b1b?style=flat-square)](https://arxiv.org/abs/2602.12056)
...
- **YC-Bench: Benchmarking AI Agents for Long-Term Planning and Consistent Execution** `2026`
...
- **WebArena: A Realistic Web Environment for Building Autonomous Agents** `2024`
- **OSWorld: Benchmarking Multimodal Agents for Open-Ended Tasks in Real Computer Environments** `NeurIPS 2024` [![arXiv](https://img.shields.io/badge/arXiv-2404.07972-b31b1b?style=flat-square)](https://arxiv.org/abs/2404.07972)
...
- **Environment Scaling for Interactive Agentic Experience Collection: A Survey** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2511.09586-b31b1b?style=flat-square)](https://arxiv.org/abs/2511.09586)
- **Self-Refine: Iterative Refinement with Self-Feedback** `2023`
- **CRITIC: Large Language Models Can Self-Correct with Tool-Interactive Critiquing** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2305.11738-b31b1b?style=flat-square)](https://arxiv.org/abs/2305.11738)
...
- **$\pi_0$: A Vision-Language-Action Flow Model for General Robot Control** `arXiv 2024` [![arXiv](https://img.shields.io/badge/arXiv-2410.24164-b31b1b?style=flat-square)](https://arxiv.org/abs/2410.24164)
- **GR00T N1: An Open Foundation Model for Generalist Humanoid Robots** `arXiv 2025` [![arXiv](https://img.shields.io/badge/arXiv-2503.14734-b31b1b?style=flat-square)](https://arxiv.org/abs/2503.14734)
